...
exports.otpEmail = (otp) => {
  ...
  <tbody>
        <tr>
          ...
          <img src="#" alt="PES Legal Services">
          </td>
          </tr>
          <tr>
          <td>
          <p style="margin-top: 0;">Hello,</p>
          <p>Thank you for signing  up with us. Please verify your email to finish signing up with PES Legal Services. Use the following verification code:</p>
          ...
          <p style="margin-top: 0; font-size: 14px;">PES Legal Services</p>
          </td>
          </tr>
          </tbody>
          </table>
...
exports.signupSuccess = () => {
  ...
  <img src="https://example.com/logo.png" alt="PES Legal Services" style="display:block; margin:0 auto; max-width:150px;">
  ...
  <p style="text-align:center;">If you have any questions or need assistance, please do not hesitate to contact us at <a href="mailto:deekshithhr3729@gmail.com">deekshithhr3729@gmail.com</a>.</p>
  ...
  body {
    ...
    -moz-osx-font-smoothing: grayscale;
          ...
          .footer {
            ...
            <p>If you need to make any changes to your appointment or have any questions, please contact us at <a href="mailto:deekshithhr3729@gmail.com">deekshithhr3729@gmail.com</a>.</p>
            <p>Thank you for choosing our services. We look forward to seeing you soon.</p>
            <div class="footer">
            <p>© 2023 PES Legal Services. All rights reserved.</p>
            </div>
            </div>        
        </body>
        </html>`
      ...
      /* Styling for the email */
        ...
        <body>
          <div class="container">
            ...
            <p>If you have any questions or concerns, please feel free to <a href="mailto:deekshithhr3729@gmail.com">deekshithhr3729@gmail.com</a>.</p>
            <p>Thank you for your understanding.</p>
            <div style="text-align:center;">
              <a href="#" class="button">Schedule a New Appointment</a>
            </div>
            <p class="signature">Best regards,<br>The PES Legal Service Team</p>
          </div>
        </body>
      </html>`
}
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
          ...
          <body style="font-family: Arial, sans-serif; font-size: 16px; line-height: 1.6; color: #333; background-color: #f4f4f4; padding: 20px;">
            <div style="background-color: #fff; max-width: 600px; margin: 0 auto; border-radius: 5px; padding: 40px;">
              ...
              <p style="margin-bottom: 20px;">You recently requested to reset your password for <b>PES Legal Services.</b> Click the button below to set a new password:</p>
              ...
              <p style="margin-bottom: 20px;">Best regards,<br><b>PES Legal Services</b> Team</p>
            </div>
          </body>
        </html>
`
...
<html>
  ...
  <body>
    <div class="email-wrapper">
      ...
      <p class="email-content">You can use these details to log in to our platform and start using our services. If you have any questions or concerns, please don't hesitate to <a class="accent-color" href="mailto:deekshithhr3729@gmail.com">contact us</a>.</p>
